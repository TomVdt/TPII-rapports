...
Les combustibles étudiés dans cette expérience possèdent tous une équation chimique de combustion similaire. Ils consomment le combustible et de l'\ce{O2} pour produire du \ce{CO2} et de l'\ce{H2O}. Les chaleurs de formation des deux produits étant élevées et négatives cela permet un fort dégagement de chaleur \cite{notice}. Il est nécessaire cependant de connaitre ces équations de combustion pour les étudier, pour l'éthanol \ce{C2H5OH} sa combustion sous sa forme liquide donne:
\begin{equation}
