...
\end{equation}
avec \(c^* = (4179.6 \pm 0.1)\) la capacité thermique massique de l'eau \cite{capacite-eau} et \(\ell_\textrm{vap}^* = 2257\) la chaleur latente massique de vaporisation de l'eau \cite{notice}.
