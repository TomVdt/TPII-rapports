...
En utilisant l'\autoref{eq:efficacite}, il est possible d'obtenir l'efficacité pour chacune de méthodes. Les résultats sont reportées dans le \autoref{tab:pm_efficacite}.
